"""Treinamento PINN HJB-Merton."""
import numpy as np
from typing import Dict, Optional
from .rede_pinn_hjb import RedePINN_HJB
from .residuo_hjb_merton import perda_hjb
...
def treinar_hjb(
    ...
    **kwargs,
    ...
    for epoca in range(1, n_epocas + 1):
        p0, _, _ = perda_hjb(rede, X_col, X_term, V_term, **kwargs)
        ...
        for j in idx:
            ...
            pj, _, _ = perda_hjb(rede, X_col, X_term, V_term, **kwargs)
            grad[j] = (pj - p0) / eps_g
        m = 0.9 * m + 0.1 * grad
        theta = theta - taxa * m
        rede.carregar_parametros(theta)
        perda, pde, term = perda_hjb(rede, X_col, X_term, V_term, **kwargs)
