# =============================================================================
# Módulo 23: SwellingFolhelhos
# Autor: Luiz Tiago Wilcke
# Capítulo 23
# =============================================================================
"""Capítulo 23 - Termo-chemo-poroelasticidade, pressão osmótica"""
...
class SwellingFolhelhos:
    ...
    def __init__(self):
        ...
        self.cfg = FISICA
        self.geo = GEOMETRIA
        LOGGER.info("SwellingFolhelhos inicializado por Luiz Tiago Wilcke")
    ...
    def resumo(self) -> Dict:
        return {
            "modulo": "SwellingFolhelhos",
            "autor": "Luiz Tiago Wilcke",
            "livro": "Redes Neurais Informadas pela Física - Volume 3",
            "descricao": "Capítulo 23 - Termo-chemo-poroelasticidade, pressão osmótica"
        }

class PINNSwellingFolhelhos(RedeBasePINN):
...
# ---------------------------------------------------------------------------
# Funções auxiliares específicas do módulo SwellingFolhelhos
# ---------------------------------------------------------------------------

def gerar_pontos_colocacao_swellingfolhelhos(n_pontos: int = 5000, dominio: Tuple = (0, 1)) -> torch.Tensor:
    """Gera pontos de colocação no domínio físico."""
    return torch.rand(n_pontos, 2) * (dominio[1] - dominio[0]) + dominio[0]

def validar_solucao_swellingfolhelhos(pred: np.ndarray, tolerancia: float = 1e-3) -> bool:
...
def exportar_resultados_swellingfolhelhos(dados: Dict, caminho: str) -> None:
