# =============================================================================
# Módulo 21: WormholesReativos
# Autor: Luiz Tiago Wilcke
# Capítulo 21
# =============================================================================
"""Capítulo 21 - Transporte reativo, acidização, alteração de porosidade"""
...
class WormholesReativos:
    ...
    def __init__(self):
        ...
        self.cfg = FISICA
        self.geo = GEOMETRIA
        LOGGER.info("WormholesReativos inicializado por Luiz Tiago Wilcke")
    ...
    def resumo(self) -> Dict:
        return {
            "modulo": "WormholesReativos",
            "autor": "Luiz Tiago Wilcke",
            "livro": "Redes Neurais Informadas pela Física - Volume 3",
            "descricao": "Capítulo 21 - Transporte reativo, acidização, alteração de porosidade"
        }

class PINNWormholesReativos(RedeBasePINN):
...
# ---------------------------------------------------------------------------
# Funções auxiliares específicas do módulo WormholesReativos
# ---------------------------------------------------------------------------

def gerar_pontos_colocacao_wormholesreativos(n_pontos: int = 5000, dominio: Tuple = (0, 1)) -> torch.Tensor:
    """Gera pontos de colocação no domínio físico."""
    return torch.rand(n_pontos, 2) * (dominio[1] - dominio[0]) + dominio[0]

def validar_solucao_wormholesreativos(pred: np.ndarray, tolerancia: float = 1e-3) -> bool:
...
def exportar_resultados_wormholesreativos(dados: Dict, caminho: str) -> None:
