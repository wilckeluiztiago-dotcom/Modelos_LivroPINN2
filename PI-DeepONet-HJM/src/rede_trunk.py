"""
Módulo 06: Rede Trunk (Processa coordenadas (t, T))
...
class RedeTrunk(nn.Module):
    """
    Trunk Net: mapeia as coordenadas de consulta y = (t, T)
    para o vetor de funções de base t(y) ∈ R^p.
    """

    def __init__(
        self,
        dim_entrada: int = 2,  # (t, T)
